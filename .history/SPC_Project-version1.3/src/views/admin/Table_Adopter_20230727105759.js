...
export default function TablesAdopters() {
  ...
  const [rows, setRows] = useState([
    {stt:"1", username:"Admin@04", password:"1234", description:"Super Manager", status:"live",stt:"1", username:"Admin@04", password:"1234", description:"Super Manager", status:"live"}
  ])
